...
For the examples of findings (like the legendary "lost city of Z”) made with the help of this tool, see my [Writeup for the Kaggle's competition OpenAI to Z Challenge](https://www.kaggle.com/competitions/openai-to-z-challenge/writeups/amazon-hidden-site-hunter) and [DEM is all you need](https://www.kaggle.com/competitions/openai-to-z-challenge/discussion/587383)
